...
//  獨立測試用
	public static void main(String[] args) {
		InsertMember IID = new InsertMember();
		IID.insertMember("dog");
	}
	...
	void insertMember(String imported_name) {
		...
		try {
			...
			String sql = "ALTER TABLE expenses "
					+ "ADD %s TINYINT "
					+ "DEFAULT 0";

			stmt.executeUpdate(sql.formatted(name));
